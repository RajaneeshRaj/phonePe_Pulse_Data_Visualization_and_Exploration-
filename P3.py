...
agg_trans_query = "SELECT * FROM my_agg_trans"
agg_users_query = "SELECT * FROM my_agg_users"
map_trans_query = "SELECT * FROM my_map_trans"
map_users_query = "SELECT * FROM my_map_users"
top_trans_query = "SELECT * FROM my_top_trans"
top_users_query = "SELECT * FROM my_top_users"
